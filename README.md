...
> **Latest (v1.4.10):** Fixed input‑opened selection bug, added pointer capture, removed debug logs, grouped-items auto-conversion in adapters; improved dark-mode support via ancestor-aware selectors; styling improvements to group headers.
